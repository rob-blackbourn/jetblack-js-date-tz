...
const flags: Record<string, (dateTz: DateTz, localeInfo: I18nSettings) => any> =
  {
    ...
    m: dateTz => dateTz.monthIndex + 1,
    mm: dateTz => String(dateTz.monthIndex + 1).padStart(2, '0'),
    mmm: (dateTz, localeInfo) => localeInfo.month.short[dateTz.monthIndex],
    mmmm: (dateTz, localeInfo) => localeInfo.month.long[dateTz.monthIndex],
